...
const NextLink: typeof NextLinkComp = (NextLinkComp as any).default || NextLinkComp;
...
export const Link = ({ children, className, href, component, secondary, ...props }: LinkProps) => {
